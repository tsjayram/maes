...
class NTMSolver(NTM):
    def __init__(self, in_dim, out_dim, aux_in_dim, tm_state_units, tm_solver_state_units,
        ...
        self.tm_solver_state_units = tm_solver_state_units
    ...
    def _build_model(self):
        ...
        n_read_heads = 1
        n_write_heads = 1
        layer = NTMLayer(self.out_dim, self.tm_solver_state_units,
                         n_read_heads, n_write_heads,
