...
LOG_ROOT = '../../logs/'
LOG_DIR = LOG_ROOT + 'reverse/{}'.format(arrow.now().format('YYYY-MM-DD__hh_mm_ss_A'))
...
def mem_weights():
    use_frozen_wts = True
    mem_freeze_wts_file = LOG_ROOT + 'common/2018-01-16__12_04_47_PM/model_weights.hdf5'
    mem_epoch = 12500
...
def build_ntm_train(element_size, tm_state_units,
    ...
    ntm_train = NTM_Solve(element_size, tm_state_units,
                          is_solve_cam, num_solve_shift,
                          N_train, M)
...
def build_ntm_test(element_size, tm_state_units,
    ...
    ntm_test = NTM_Solve(element_size, tm_state_units,
                         is_solve_cam, num_solve_shift,
                         N_test, M)
